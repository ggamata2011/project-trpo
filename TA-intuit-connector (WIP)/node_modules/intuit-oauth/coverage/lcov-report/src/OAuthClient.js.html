    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">86.83% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>211/243</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>105/140</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">88.49% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>200/226</span>
            </div>
...
&nbsp;
OAuthClient.prototype.setAuthorizeURLs = function <span class="fstat-no" title="function not covered" >setAuthorizeURLs(</span>params) {
  // check if the customURL's are passed correctly
<span class="cstat-no" title="statement not covered" >  if (!params) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Provide the custom authorize URL's");</span>
  }
<span class="cstat-no" title="statement not covered" >  OAuthClient.authorizeEndpoint = params.authorizeEndpoint;</span>
<span class="cstat-no" title="statement not covered" >  OAuthClient.tokenEndpoint = params.tokenEndpoint;</span>
<span class="cstat-no" title="statement not covered" >  OAuthClient.revokeEndpoint = params.revokeEndpoint;</span>
<span class="cstat-no" title="statement not covered" >  this.environment === 'sandbox'</span>
...
&nbsp;
    ...
    .then((res) =&gt; {
      const authResponse = res.hasOwnProperty('json')? res : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
...
OAuthClient.prototype.makeApiCall = function makeApiCall(params) {
  return new Promise((resolve) =&gt; {
    ...
    const responseType = params.responseType ? <span class="branch-0 cbranch-no" title="branch not covered" >params.responseType </span>: 'json';
&nbsp;
    const baseHeaders = {
...
&nbsp;
    params.body &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >request.data = params.body)</span>;
&nbsp;
    resolve(this.getTokenRequest(request));
  })
    .then((res) =&gt; {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if(authResponse.json === null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >body)</span> {
...
OAuthClient.prototype.loadResponseFromJWKsURI = function loadResponseFromJWKsURI(request) {
  return axios.get(request).then(<span class="fstat-no" title="function not covered" >(r</span>esponse) =&gt; <span class="cstat-no" title="statement not covered" >response)</span>;
};
&nbsp;
/**
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (authResponse.response.statusText) {
...
&nbsp;
  e.error_description = '';
  <span class="missing-if-branch" title="else path not taken" >E</span>if ('error_description' in authResponse.getJson()) {
    e.error_description = authResponse.getJson().error_description;
  } else <span class="cstat-no" title="statement not covered" >if (authResponse.response.statusText) {</span>
