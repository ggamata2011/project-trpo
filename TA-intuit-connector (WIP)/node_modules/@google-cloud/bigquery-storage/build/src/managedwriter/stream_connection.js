...
const pending_write_1 = require("./pending_write");
...
class StreamConnection extends events_1.EventEmitter {
    constructor(streamId, writeClient, options) {
        super();
    ...
    trace(msg, ...otherArgs) {
        (0, logger_1.logger)('stream_connection', msg, ...otherArgs);
    }
    handleRetry(err) {
        const retrySettings = this._writeClient._retrySettings;
    ...
    write(request) {
        ...
        const pw = new pending_write_1.PendingWrite(request);
        this.send(pw);
        return pw;
    }
    send(pw) {
...
//# sourceMappingURL=stream_connection.js.map