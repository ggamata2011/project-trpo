...
exports.parseStorageErrors = parseStorageErrors;
 ...
 */
function parseStorageErrors(err) {
    const storageErrors = [];
    if (err.metadata &&
        err.metadata.get('google.cloud.bigquery.storage.v1.storageerror-bin')) {
        const serrors = err.metadata.get('google.cloud.bigquery.storage.v1.storageerror-bin');
