...
exports.bqModeToFieldLabelMapProto3 = exports.bqModeToFieldLabelMapProto2 = exports.bqTypeToFieldTypeMap = void 0;
exports.convertModeToLabel = convertModeToLabel;
...
exports.bqModeToFieldLabelMapProto2 = {
...
exports.bqModeToFieldLabelMapProto3 = {
    [TableFieldSchema.Mode.NULLABLE]: FieldDescriptorProto.Label.LABEL_OPTIONAL,
    NULLABLE: FieldDescriptorProto.Label.LABEL_OPTIONAL,
    [protos.google.cloud.bigquery.storage.v1.TableFieldSchema.Mode.REPEATED]: FieldDescriptorProto.Label.LABEL_REPEATED,
    REPEATED: FieldDescriptorProto.Label.LABEL_REPEATED,
    [protos.google.cloud.bigquery.storage.v1.TableFieldSchema.Mode.REQUIRED]: FieldDescriptorProto.Label.LABEL_OPTIONAL,
    REQUIRED: FieldDescriptorProto.Label.LABEL_REQUIRED,
    [protos.google.cloud.bigquery.storage.v1.TableFieldSchema.Mode
        .MODE_UNSPECIFIED]: null,
    MODE_UNSPECIFIED: null,
};
function convertModeToLabel(mode, useProto3) {
    if (!mode) {
        return null;
    }
    return useProto3
        ? exports.bqModeToFieldLabelMapProto3[mode]
        : exports.bqModeToFieldLabelMapProto2[mode];
}
//# sourceMappingURL=proto_mappings.js.map