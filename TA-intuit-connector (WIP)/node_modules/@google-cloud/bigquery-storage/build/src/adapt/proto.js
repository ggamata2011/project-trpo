...
exports.isProtoCompatible = isProtoCompatible;
exports.generatePlaceholderFieldName = generatePlaceholderFieldName;
 ...
 */
function convertStorageSchemaToProto2Descriptor(schema, scope, ...opts) {
    const fds = convertStorageSchemaToFileDescriptorInternal(schema, scope, false, ...opts);
 ...
 * @returns DescriptorProto
 */
function convertStorageSchemaToProto3Descriptor(schema, scope, ...opts) {
    const fds = convertStorageSchemaToFileDescriptorInternal(schema, scope, true, ...opts);
    return normalizeDescriptorSet(fds);
}
function convertStorageSchemaToFileDescriptorInternal(schema, scope, useProto3, ...opts) {
    var _a, _b, _c;
    let adaptOpts = {
 ...
 */
function isProtoCompatible(fieldName) {
 ...
 */
function generatePlaceholderFieldName(fieldName) {
    return ('field_' +
