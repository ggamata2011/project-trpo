...
exports.withChangeType = withChangeType;
exports.withChangeSequenceNumber = withChangeSequenceNumber;
/**
 ...
 */
function withChangeSequenceNumber() {
    return (opts) => ({
        ...opts,
