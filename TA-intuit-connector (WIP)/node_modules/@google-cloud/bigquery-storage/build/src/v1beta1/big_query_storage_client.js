 ...
 */
const gapicConfig = require("./big_query_storage_client_config.json");
...
class BigQueryStorageClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.storage.v1beta1.BigQueryStorage', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.bigQueryStorageStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.bigquery.storage.v1beta1.BigQueryStorage')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.bigquery.storage.v1beta1
                    .BigQueryStorage, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of bigQueryStorageStubMethods) {
            const callPromise = this.bigQueryStorageStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.BigQueryStorageClient = BigQueryStorageClient;
//# sourceMappingURL=big_query_storage_client.js.map