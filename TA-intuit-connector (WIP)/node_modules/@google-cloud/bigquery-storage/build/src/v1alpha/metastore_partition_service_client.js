...
exports.MetastorePartitionServiceClient = void 0;
 ...
 */
const gapicConfig = require("./metastore_partition_service_client_config.json");
...
class MetastorePartitionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.storage.v1alpha.MetastorePartitionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.metastorePartitionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.bigquery.storage.v1alpha.MetastorePartitionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.bigquery.storage.v1alpha
                    .MetastorePartitionService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of metastorePartitionServiceStubMethods) {
            const callPromise = this.metastorePartitionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    batchCreateMetastorePartitions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    batchDeleteMetastorePartitions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    batchUpdateMetastorePartitions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listMetastorePartitions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.MetastorePartitionServiceClient = MetastorePartitionServiceClient;
//# sourceMappingURL=metastore_partition_service_client.js.map